...
static void UseSacredAsh(u8 taskId)
{
    ...
    if (GetMonData(mon, MON_DATA_MAX_HP) <= 48)
        ...
        PartyMenuModifyHP(taskId, gPartyMenu.slotId, max(GetMonData(mon, MON_DATA_MAX_HP) / (48 / 2), 1), GetMonData(mon, MON_DATA_HP) - hp, Task_SacredAshDisplayHPRestored);    ResetHPTaskData(taskId, 0, hp);
